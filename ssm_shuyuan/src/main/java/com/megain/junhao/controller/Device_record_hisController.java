...
public class Device_record_hisController {
    ...
    @ResponseBody
    public Map<String,Map<String,Object>> echartsweek(Integer devId) {// List<Map<String, Object>>      List<Integer> 返回lights    Map<String,Map<String,Object>>  Map<String, Object>
